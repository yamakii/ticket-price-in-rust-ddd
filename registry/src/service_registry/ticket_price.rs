use crate::service_registry::DbServiceRegistry;
use domain::service::ticket_price::{
    HaveBasicPriceService, HaveCustomerTypeDiscountService, HaveTicketPriceService,
    IsTicketPriceService,
};
use infra::db::service::ticket_price::{DbBasicPriceService, DbCustomerTypeDiscountService};
