use crate::db::model::{CustomerTypeDiscountDTO, MovieDTO};
use crate::db::schema::customer_type_discounts::dsl::customer_type_discounts;
use crate::db::schema::movies::dsl::movies;
